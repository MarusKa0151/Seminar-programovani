...
//credits to Horký
/*když chceme html, tak je lepší použít rozhraní namísto mnoha ifů*/

/*vystup = vyrok ? moznost1 : moznost2
pokud je vyrok pravdivy, tak to udela to pred dvojteckou, pokud ne, tak to za dvojteckou*/
...
public class Faktura {
    ...
    public static void opakujTecky(int kolikrat) {
    ...
    public static class TextovyTisk implements Tisk {
		...
		public void polozka(String nazev, int cena) {
            ...
            int kolikrat = 30 - nazev.length() - Integer.toString(cena).length();
            opakujTecky(kolikrat);
            System.out.printf("%d\n", cena);
        }
    }
