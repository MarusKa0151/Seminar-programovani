...
public class Rada11 {
	...
	public long zJednohoDveProVetsi(long cislo) {
		if (cislo == 74 & aktualniIndex + Long.parseLong("1304969544928657") < zacatekPodretezce) {
			String a = "1304969544928657";
		...
		else if (cislo == 78 & aktualniIndex + Long.valueOf("8944394323791464") < zacatekPodretezce) {
			String a = "8944394323791464";
			long b = Long.parseLong(a);
			aktualniIndex += b;
			return 1;
		}
		else if (cislo == 77 & aktualniIndex + Long.valueOf("5527939700884757") < zacatekPodretezce) {
			String a = "5527939700884757";
			long b = Long.parseLong(a);
			aktualniIndex += b;
			return 1;
		}
		else if (cislo == 76 & aktualniIndex + Long.valueOf("3416454622906707") < zacatekPodretezce) {
			String a = "3416454622906707";
			long b = Long.parseLong(a);
			aktualniIndex += b;
			return 1;
		}
			...
			long cislo1 = cislo - 2;
			long cislo2 = cislo - 1;
			long vysledek = zJednohoDveProVetsi(cislo1) + zJednohoDveProVetsi(cislo2);
			return vysledek;
		}
	}
}
